...
//        mHistoryList =mMyApplication.getListHistory();
        mRecyclerView=(RecyclerView) findViewById( R.id.rcy2 );
        ...
        public void bind(final Data news) {
            ...
            mTextView1.setOnClickListener( new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(HistoryActivity.this, news.getTitle(), Toast.LENGTH_LONG).show();
                    Intent intent =new Intent(HistoryActivity.this,WebNews.class);
            ...
            Glide.with( HistoryActivity.this ).load( pic ).into( mImageView );
        }
    }
